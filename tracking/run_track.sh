...
ssh -o "StrictHostKeyChecking no" -t login1.int.janelia.org \
    "bsub -n 8 -gpu \"num=1\" -q gpu_l4 -W 24:00 -o \"/groups/zhang/home/zhangl5/Emily/Video_Process/.apt/track/track_${VIDEO_NAME}.log\" \
    ...
    -conf_params batch_size 8 -type deeplabcut -model_files '/groups/zhang/home/zhangl5/Emily/Video_Process/tracking/0916_DLC/deepnet-587000' \
